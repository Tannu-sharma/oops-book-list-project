...
//delete book on clicking X button
UI.prototype.deleteBook = function(target){
    if(target.className === 'delete'){ 
        target.parentElement.parentElement.remove();                                                                              //this remove tr tag from the dom                                                                                   //here target contains a tag and it is dynamically created and it is under tr->td->a tag hence we want to delete tr therefore we have to go to its parent of parent
